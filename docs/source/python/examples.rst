...
.. literalinclude:: ../../../python/examples/synchronous_example.py
   :language: python
   :linenos:
   :caption: synchronous_example.py

Example showing asynchronous usage with callbacks for progress monitoring.

.. literalinclude:: ../../../python/examples/async_callbacks_example.py
   :language: python
   :linenos:
...
.. literalinclude:: ../../../python/examples/async_generator_example.py
   :language: python
   :linenos:
   :caption: async_generator_example.py
...
.. literalinclude:: ../../../python/examples/image_generation_example.py
   :language: python
   :linenos:
   :caption: image_generation_example.py
...
.. literalinclude:: ../../../python/examples/tts_sync_example.py
   :language: python
   :linenos:
   :caption: tts_sync_example.py


Example showing asynchronous text-to-speech generation using the AIME API client interface.

.. literalinclude:: ../../../python/examples/tts_async_example.py
   :language: python
   :linenos:
